##REFF : https://redhuli.io/use-tkinter-to-design-gui-layout/
...
root.minsize(900, 600) # specify the max size the window can expand to
...
image = PhotoImage(file="../Self/giphy.gif")
