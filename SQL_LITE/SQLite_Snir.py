...
def query():
    ...
    query_label.grid(row=13, column=1, columnspan=4)
...
# Create and pack buttons on grid
#
...
query_btn.grid(row=10, column=1, columnspan=2, pady=10, padx=10, ipadx=40)

# Ceate a Delete button
delete_btn = Button(root, text="Delete Record", command=delete)
delete_btn.grid(row=9, column=3, columnspan=2, pady=10, padx=10, ipadx=20)

# Ceate a Edit button
edit_btn = Button(root, text="Edit Record", command=edit)
edit_btn.grid(row=9, column=2, columnspan=1, pady=10, padx=10, ipadx=20)
